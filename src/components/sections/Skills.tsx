...
const techStack = {
    ...
    "AI/ML & NLP": [
        ...
        { name: "Prompt Engineering", icon: "/skills/prompt-engineering.png" },
        { name: "RAG", icon: "/skills/rag.png" },
        { name: "Embeddings", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/tensorflow/tensorflow-original.svg" },
        { name: "Tokenization", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/numpy/numpy-original.svg" },
    ],
    "FRONTEND": [
    ...
    "DATABASES": [
        ...
        { name: "Vector DBs", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/pinecone/pinecone-original.svg" },
    ...
    "DATA PIPELINES": [
        ...
        { name: "Apache Kafka", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/apachekafka/apachekafka-original.svg", invert: true },
        { name: "Airflow", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/apacheairflow/apacheairflow-original.svg" },
        { name: "ETL Workflows", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/pandas/pandas-original.svg" },
    ],
    "CLOUD & DEVOPS": [
    ...
    "TOOLS & METHODS": [
        ...
        { name: "GitHub Copilot", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original.svg", invert: true },
        { name: "Unit Testing", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/pytest/pytest-original.svg" },
    ],
}
